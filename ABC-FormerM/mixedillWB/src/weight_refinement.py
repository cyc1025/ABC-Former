...
import os
import mixedillWB.bilateral_solver.bilateral_grid as bilateral_grid
import mixedillWB.bilateral_solver.bilateral_solver as solver
import numpy as np
import torch
...
def process_image(reference, target, confidence=None, tensor=False):
    if confidence is None:
        confidence = ops.imread(os.path.join('mixedillWB/bilateral_solver', 'confidence.png'), gray=True)
